...
namespace Silmoon.Windows.Forms.Extensions
{
    public class GenieExtension
    {
        ...
        public void ShowControl(Control control, bool changeColor, int delaySecound)
        {
            if (changeColor)
                ThreadHelper.ExecAsync(colorProc, new object[] { control, delaySecound }, null);
            ThreadHelper.ExecAsync(scrollProc, new object[] { control, delaySecound }, null);
        }
        ...
        public void FocusSlide(Control control, int maxSize, int minSize, int delaySecound)
        {
            object obj = (object)new object[] { control, maxSize, minSize, delaySecound };
